...
import { API, Camera, Config } from "services/api";
import {
  Accordion,
  AccordionHeader,
  AccordionBody,
        ...
        <div className="space-y-12">
          ...
          <div className="border-b border-gray-900/10 pb-12">
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 content-start">
              <div className="sm:col-span-2 ">
                <label className="block text-sm leading-6 text-gray-400">
                  The SendGrid API Key. See <a href="https://docs.sendgrid.com/ui/account-and-settings/api-keys">Sendgrid</a> for more information.
                </label>
              </div>
              <div className="sm:col-span-2">
                <label htmlFor="removeTempFiles" className="block text-sm font-medium leading-6 text-gray-900">
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 content-start">
              <div className="sm:col-span-2 ">
                <label className="block text-sm leading-6 text-gray-400">
                  The sender email address. This has to be configured as a sender in SendGrid, see <a href="https://docs.sendgrid.com/glossary/sender-authentication">sender-authentication</a> for more information.
                </label>
              </div>
              <div className="sm:col-span-2">
                <label htmlFor="removeTempFiles" className="block text-sm font-medium leading-6 text-gray-900">
          ...
          <div>
            ...
            {cameras.map((cam, i) => {      
              return (
                <Accordion open={accOpen === cam.id} animate={accAnimation} className={` ${accOpen === cam.id ? 'border-b border-gray-900/10' : ''}`}>
                  <AccordionHeader onClick={() => handleAccOpen(cam.id)} className={`border-b-0 transition-colors ${accOpen === cam.id ? 'text-cyan-500 hover:!text-cyan-500' : 'text-gray-900'}`}>{cam.name}</AccordionHeader>
                  <AccordionBody>
                  <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 content-start">
                    <div className="sm:col-span-2 ">
                      <label className="block text-sm leading-6 text-gray-400">
